    ...
    if (calculateCm.value === '' || calculateKg.value === '') {
        ...
        async function generatedAnswer() {
            ...
            openai.chat.completions.create({
                ...
                messages: [
                    { role: "user", content: `من اطلاعات ویژگی‌های جسمی خودم را با اندازه وزن ${kg} کیلوگرم و قد ${cm} سانتی‌متر ارائه می‌دهم. در انتظار یک پاسخ هوش مصنوعی هستم که تنها با یک اجرا، به صورت هوشمندانه نام و بیوگرافی کوتاه یک شخصیت تاریخی ${lastSelectedValue} را با ابراز تحسین به من ارائه دهد. اگر قد و وزن من شبیه با شخصیت بخصوصی در تاریخ نیست، لطفا درباره کسی صحبت کن من بیشترین شباهت را به آن دارم.` },
                ],
